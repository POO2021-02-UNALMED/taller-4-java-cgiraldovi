...
public class Taller4 {
    ...
    public static void main(String[] args) {
        ...
        Asignatura asignatura2 = new Asignatura(882); // se elimino 882 dentro del constructor
        ...
        System.out.println(new Asignatura().nombre);    //listo
        System.out.println(grupo2.codigo);              //listo
        System.out.println(asignatura2.codigoExterno);  //listo
        asignatura1.cambiarDatos(50);       //listo
        System.out.println(asignatura1.codigoExterno);
        System.out.println(estudiantes1[1].cedula);     //listo
