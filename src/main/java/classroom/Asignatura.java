...
public class Asignatura {
    ...
    //Asignatura(int codigoInterno) {this("Sin nombre", codigoInterno, 0);}
    //se elimino este constructor por la redundancia de constructores
    ...
    //se elimino este constructor por la redundancia de metodos
